...
def conv1x1(in_planes, out_planes, stride=1, WeightS=WeightS):
    """1x1 convolution"""
    return L.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False, WeightS=WeightS)
...
def l_resnet50(pretrained=False, WeightS=WeightS, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3],WeightS=WeightS, **kwargs)
    return model
